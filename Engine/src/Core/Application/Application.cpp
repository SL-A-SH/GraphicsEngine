...
bool ApplicationClass::Initialize(int screenWidth, int screenHeight, HWND hwnd)
{
	...
	strcpy_s(bitmapFilename, "../Engine/assets/textures/stone01.tga");

	// Create and initialize the bitmap object.
	m_Bitmap = new BitmapClass;

	result = m_Bitmap->Initialize(m_Direct3D->GetDevice(), m_Direct3D->GetDeviceContext(), screenWidth, screenHeight, bitmapFilename, 20, screenHeight - 500);
	if (!result)
	{
		return false;
	}
